...
/area/shuttle/m939/first
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST

/area/shuttle/m939/second
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST

/area/shuttle/m939/third
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST

/area/shuttle/m939/first/transit
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST
	forced_ambience = list('sound/effects/dieseltruckloop2.wav')

/area/shuttle/m939/second/transit
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST
	forced_ambience = list('sound/effects/dieseltruckloop2.wav')

/area/shuttle/m939/third/transit
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST
	forced_ambience = list('sound/effects/dieseltruckloop2.wav')

/area/shuttle/m939/first/destination
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST

/area/shuttle/m939/second/destination
	requires_power = 0
	base_turf = /turf/unsimulated/floor/road
	sound_env = FOREST

/area/shuttle/m939/third/destination
	requires_power = 0
	base_turf = /turf/frozenground/
	sound_env = FOREST
