...
/obj/random/helmet
	...
	item_to_spawn()
		return pick(prob(1);/obj/item/clothing/head/helmet/m1,\
					prob(1);/obj/item/clothing/head/helmet/m1/winter,\
					prob(4);/obj/item/clothing/head/helmet/pasgt,\
					prob(4);/obj/item/clothing/head/helmet/pasgt/winter)
...
/obj/random/armorvest
	...
	item_to_spawn()
		return pick(prob(1);/obj/item/clothing/suit/storage/vest/usflak,\
					prob(4);/obj/item/clothing/suit/storage/vest/pasgt,\
					prob(4);/obj/item/clothing/suit/storage/vest/pasgt/woodland)
