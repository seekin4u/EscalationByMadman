...
/obj/item/device/radio/intercom/soviet/transmitter
...
/obj/item/device/radio/intercom/soviet/receiver
...
/obj/item/device/radio/intercom/soviet/receiver/attack_self(mob/user)
	return

/obj/item/device/radio/intercom/usmc/transmitter
	name = "\improper transmitter"
	desc = "Used to send messages on the all loudspeakers."
	frequency = 1633
	icon_state = "transmitter"
...
/obj/item/device/radio/intercom/usmc/transmitter/attack_self(mob/user)
	return

/obj/item/device/radio/intercom/usmc/receiver
	name = "\improper loudspeaker"
	desc = "Listen through this."
	icon_state = "loudspeaker"
	frequency = 1633
...
/obj/item/device/radio/intercom/usmc/receiver/attack_self(mob/user)
	return
