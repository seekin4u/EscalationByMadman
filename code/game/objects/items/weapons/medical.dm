...
/obj/item/weapon/storage/box/ampule_box/morphine
	...
	startswith = list(/obj/item/weapon/ampule_pack/morphine = 4)
...
/obj/item/weapon/ampule_pack/attack_hand(mob/user as mob)
	if(user.get_inactive_hand() == src)
		if(src.contents.len > 0)
			var/obj/item/weapon/reagent_containers/ampule/ampule = contents[1]
...
/obj/item/weapon/ampule_pack/morphine
	...
	ampule_type = /obj/item/weapon/reagent_containers/ampule/morphine
