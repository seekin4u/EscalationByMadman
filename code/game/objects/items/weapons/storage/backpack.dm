...
/obj/item/weapon/storage/backpack/satchel/correspondent
	New()
		..()
...
/obj/item/weapon/storage/box/summedsan
	...
	startswith = list(
			...
			/obj/item/weapon/folder/notebook)
	can_hold = list(
...
/obj/item/weapon/storage/box/comlifbag
	...
	max_storage_space = DEFAULT_LARGEBOX_STORAGE
	startswith = list(
			/obj/item/weapon/storage/box/ampule_box/morphine = 4,
			/obj/item/weapon/storage/box/pill_box/paracetamol = 1,
			/obj/item/weapon/storage/box/pill_box/doxycycline = 1,
			/obj/item/clothing/gloves/latex = 1,
			/obj/item/weapon/gauze_pack/gauze = 8,
			/obj/item/weapon/reagent_containers/hypospray/autoinjector/combat/epinephrine = 4,
...
/obj/item/weapon/storage/backpack/usmc
	name = "military backpack"
	desc = "Used to store things. Used by USMC."
	icon_state = "usmcbackpack"
	max_storage_space = DEFAULT_BACKPACK_STORAGE - 4

/obj/item/weapon/storage/backpack/usmc/New()
	..()
	slowdown_per_slot[slot_back] = 1

/obj/item/weapon/storage/backpack/kitbag
	name = "kitbag"
	desc = "That's a generic haversack used by Soviet Army."
	icon_state = "sovietbackpack"
	max_storage_space = DEFAULT_BACKPACK_STORAGE - 2

/obj/item/weapon/storage/backpack/kitbag/New()
	..()
	slowdown_per_slot[slot_back] = 2

/obj/item/weapon/storage/backpack/surgery
	name = "field surgeon kit"
	desc = "Used for field surgery, obvious!"
...
/obj/item/weapon/storage/backpack/surgery/New()
	..()
	slowdown_per_slot[slot_back] = 1
