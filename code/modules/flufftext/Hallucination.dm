			...
			if(41 to 65)
				...
				switch(rand(1,12))
					...
					if(9)
						...
						var/gunshot = pick('sound/weapons/gunshot/gunshot_strong.ogg', 'sound/weapons/gunshot/gunshot2.ogg', 'sound/weapons/gunshot/shotgun.wav', 'sound/weapons/gunshot/gunshot.ogg')
						src << gunshot
						spawn(rand(10,30))
							src << gunshot
