...
/client/proc/show_battle_report()
	set category = "Fun"
	set name = "Show situation report"

	var/alive_ovd = 0
	var/alive_nato = 0

	var/heavily_injured_ovd = 0
	var/heavily_injured_nato = 0
	...
	usr << "NATO: [alive_nato] alive, [heavily_injured_nato] heavily injured and [dead_nato] dead."
	usr << "OVD: [alive_ovd] alive, [heavily_injured_ovd] heavily injured and [dead_ovd] dead."

	var/public = alert(usr, "Show it to public?",,"Yes", "No")

	if(public == "Yes")
		world << "<font size=4>Battle status report:</font>"
		world << "<font size=3>NATO: [alive_nato] alive, [heavily_injured_nato] heavily injured and [dead_nato] dead.</font>"
		world << "<font size=3>OVD: [alive_ovd] alive, [heavily_injured_ovd] heavily injured and [dead_ovd] dead.</font>"
