...
//	recipes += new/datum/stack_recipe("key", /obj/item/weapon/key, 1, time = 10, one_per_turf = 0, on_floor = 1)
	...
	recipes += new/datum/stack_recipe("closet", /obj/structure/closet, 5, time = 15, one_per_turf = 1, on_floor = 1)
...
//	recipes += new/datum/stack_recipe("metal barricade", /obj/structure/m_barricade, 15, time = 160, one_per_turf = 1, on_floor = 1)
	recipes += new/datum/stack_recipe("wall girders", /obj/structure/girder, 5, time = 100, one_per_turf = 1, on_floor = 1)
...
//	recipes += new/datum/stack_recipe("crossbow frame", /obj/item/weapon/crossbowframe, 5, time = 25, one_per_turf = 0, on_floor = 0)
	recipes += new/datum/stack_recipe("coffin", /obj/structure/closet/coffin, 5, time = 70, one_per_turf = 1, on_floor = 1)
...
//	recipes += new/datum/stack_recipe("book shelf", /obj/structure/bookcase, 5, time = 15, one_per_turf = 1, on_floor = 1)
	recipes += new/datum/stack_recipe("full-tile barricade", /obj/structure/barricade, 15, time = 90, one_per_turf = 1, on_floor = 1, supplied_material = "[name]")
	recipes += new/datum/stack_recipe("barricade", /obj/structure/barricade/oneside, 5, time = 50, one_per_turf = 4, on_floor = 1, supplied_material = "[name]")
