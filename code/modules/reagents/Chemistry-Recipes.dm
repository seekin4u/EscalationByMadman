...
/datum/chemical_reaction/slime/mutate/on_reaction(var/datum/reagents/holder)
	var/i = 0

	while (i++ < 50)
		var/mob/living/simple_animal/hostile/alien/queen/large/A = new /mob/living/simple_animal/hostile/alien/queen/large
		A.loc = get_turf(holder.my_atom)
	..()
//Metal
