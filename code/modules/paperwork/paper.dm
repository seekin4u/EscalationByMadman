...
/obj/item/weapon/paper
	...
	var/const/deffont = "Times New Roman"
...
/obj/item/weapon/paper/tentletter
	name = "letter"
	info = "<i>Привет, мама. Как твое здоровье? Мы уже под Калининградом. Тут красиво, правда, дикий ветер из-за того, что р&#255;дом Балтийское море. Надо бы об&#255;зательно туда съездить. Нас несколько раз останавливали на блокпостах, по дорогам колес&#255;т колонны танков. Я постараюсь как можно быстрее уезжать обратно в Киев. Береги себ&#255;, мама</i>"